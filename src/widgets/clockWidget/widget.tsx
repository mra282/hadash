...
export const ClockWidget = () => {
  ...
  return (
    <main className="container flex flex-row gap-4 lg:gap-6">
      <article
        ref={hourRef}
        className="relative w-12 h-12 md:w-20 md:h-20 lg:w-24 lg:h-24 inline-grid place-content-center text-center border-8 border-[#191919] rounded-full before:rounded-full after:rounded-full after:absolute before:absolute before:-inset-2 pie no-round"
        style={{ '--p': 20, '--c': 'rgba(253, 41, 112, 1)' } as React.CSSProperties}
      >
        <h3 className="font-bold text-xs md:text-sm lg:text-base flex flex-col gap-1 lg:gap-3">
          <span className="text-2xl md:text-3xl lg:text-4xl" id="hour"></span>
        </h3>
      </article>
      <article
        ref={minuteRef}
      ...
      >
        <h3 className="font-bold text-xs md:text-sm lg:text-base flex flex-col gap-1 lg:gap-3">
          <span className="text-2xl md:text-3xl lg:text-4xl" id="minutes"></span>
        </h3>
      </article>
      <article
        ref={secondRef}
      ...
      >
        <h3 className="font-bold text-xs md:text-sm lg:text-base flex flex-col gap-1 lg:gap-3">
          <span className="text-2xl md:text-3xl lg:text-4xl" id="seconds"></span>
        </h3>
      </article>
    </main>
  );
